...
1. **AI Product Review Analytics System | Python, FastAPI, Streamlit, JavaScript, Scikit-Learn, NLP** | Designed and deployed an AI-powered product review analytics pipeline using Python, FastAPI, Streamlit, and Sentence-Transformer embeddings to perform sentiment analysis, K-Means clustering, and customer pain-point identification from large-scale CSV review data. Optimized processing through ThreadPool-based parallelization and developed interactive dashboards with JavaScript-enhanced visualizations to deliver actionable product insights and scalable, data-driven recommendations. [Link](https://github.com/Rikan-Saha/Product-Review-Analytics)
